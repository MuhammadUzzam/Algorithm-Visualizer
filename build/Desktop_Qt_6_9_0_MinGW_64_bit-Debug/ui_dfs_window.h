/********************************************************************************
** Form generated from reading UI file 'dfs_window.ui'
**
...
#ifndef UI_DFS_WINDOW_H
#define UI_DFS_WINDOW_H
...
public:
    ...
    void setupUi(QMainWindow *dfs_window)
    {
        if (dfs_window->objectName().isEmpty())
            dfs_window->setObjectName("dfs_window");
        dfs_window->resize(747, 590);
        centralwidget = new QWidget(dfs_window);
...
"}"));
        ...
        btnRunDFS = new QPushButton(centralwidget);
        btnRunDFS->setObjectName("btnRunDFS");
        btnRunDFS->setStyleSheet(QString::fromUtf8("    QPushButton {\n"
...
"    }"));
        ...
        verticalLayout->addWidget(btnRunDFS);
...
"    }"));
        ...
        dfs_window->setCentralWidget(centralwidget);
        menubar = new QMenuBar(dfs_window);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 747, 21));
        dfs_window->setMenuBar(menubar);
        statusbar = new QStatusBar(dfs_window);
        statusbar->setObjectName("statusbar");
        dfs_window->setStatusBar(statusbar);

        retranslateUi(dfs_window);

        QMetaObject::connectSlotsByName(dfs_window);
    } // setupUi

    void retranslateUi(QMainWindow *dfs_window)
    {
        dfs_window->setWindowTitle(QCoreApplication::translate("dfs_window", "MainWindow", nullptr));
        label->setText(QCoreApplication::translate("dfs_window", "Depth First Search Visualization", nullptr));
        btnRunDFS->setText(QCoreApplication::translate("dfs_window", "Run DFS", nullptr));
        btnAddEdge->setText(QCoreApplication::translate("dfs_window", "Add Edge", nullptr));
        btnAddNode->setText(QCoreApplication::translate("dfs_window", "Add Node", nullptr));
        btnClearGraph->setText(QCoreApplication::translate("dfs_window", "Clear Graph", nullptr));
        btnRemoveNode->setText(QCoreApplication::translate("dfs_window", "Remove Node", nullptr));
        btnRandomGraph->setText(QCoreApplication::translate("dfs_window", "Random Graph", nullptr));
        btnBack->setText(QCoreApplication::translate("dfs_window", "back", nullptr));
    } // retranslateUi

};

namespace Ui {
    class dfs_window: public Ui_dfs_window {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DFS_WINDOW_H
