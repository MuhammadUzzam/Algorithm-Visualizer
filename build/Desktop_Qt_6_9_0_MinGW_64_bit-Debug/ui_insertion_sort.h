...
#ifndef UI_INSERTION_SORT_H
#define UI_INSERTION_SORT_H
...
public:
    ...
    void setupUi(QMainWindow *Insertion_sort)
    {
        if (Insertion_sort->objectName().isEmpty())
            Insertion_sort->setObjectName("Insertion_sort");
        Insertion_sort->resize(800, 600);
        Insertion_sort->setStyleSheet(QString::fromUtf8("QWidget {\n"
...
"    );\n"
"}"));
        centralwidget = new QWidget(Insertion_sort);
...
"    }"));
        ...
        Insertion_sort->setCentralWidget(centralwidget);
        menubar = new QMenuBar(Insertion_sort);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 18));
        Insertion_sort->setMenuBar(menubar);
        statusbar = new QStatusBar(Insertion_sort);
        statusbar->setObjectName("statusbar");
        Insertion_sort->setStatusBar(statusbar);

        retranslateUi(Insertion_sort);

        QMetaObject::connectSlotsByName(Insertion_sort);
    } // setupUi

    void retranslateUi(QMainWindow *Insertion_sort)
    {
        Insertion_sort->setWindowTitle(QCoreApplication::translate("Insertion_sort", "MainWindow", nullptr));
        lblTitle->setText(QCoreApplication::translate("Insertion_sort", "Insertion Sort Visualization", nullptr));
        btnReset->setText(QCoreApplication::translate("Insertion_sort", "Reset", nullptr));
        btnRandomize->setText(QCoreApplication::translate("Insertion_sort", "Randomize", nullptr));
        btnPause->setText(QCoreApplication::translate("Insertion_sort", "Pause", nullptr));
        btnStart->setText(QCoreApplication::translate("Insertion_sort", "Start", nullptr));
        lblOperation->setText(QCoreApplication::translate("Insertion_sort", "TextLabel", nullptr));
        btnBack->setText(QCoreApplication::translate("Insertion_sort", "back", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Insertion_sort: public Ui_Insertion_sort {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_INSERTION_SORT_H
