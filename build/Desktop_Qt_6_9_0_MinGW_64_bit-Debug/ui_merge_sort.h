/********************************************************************************
** Form generated from reading UI file 'merge_sort.ui'
**
...
#ifndef UI_MERGE_SORT_H
#define UI_MERGE_SORT_H
...
public:
    ...
    void setupUi(QMainWindow *Merge_sort)
    {
        if (Merge_sort->objectName().isEmpty())
            Merge_sort->setObjectName("Merge_sort");
        Merge_sort->resize(800, 600);
        Merge_sort->setStyleSheet(QString::fromUtf8("QWidget {\n"
...
"    );\n"
"}"));
        centralwidget = new QWidget(Merge_sort);
...
"    }"));
        ...
        Merge_sort->setCentralWidget(centralwidget);
        menubar = new QMenuBar(Merge_sort);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 18));
        Merge_sort->setMenuBar(menubar);
        statusbar = new QStatusBar(Merge_sort);
        statusbar->setObjectName("statusbar");
        Merge_sort->setStatusBar(statusbar);

        retranslateUi(Merge_sort);

        QMetaObject::connectSlotsByName(Merge_sort);
    } // setupUi

    void retranslateUi(QMainWindow *Merge_sort)
    {
        Merge_sort->setWindowTitle(QCoreApplication::translate("Merge_sort", "MainWindow", nullptr));
        lblTitle->setText(QCoreApplication::translate("Merge_sort", "Merge Sort Visualization", nullptr));
        btnReset->setText(QCoreApplication::translate("Merge_sort", "Reset", nullptr));
        btnRandomize->setText(QCoreApplication::translate("Merge_sort", "Randomize", nullptr));
        btnPause->setText(QCoreApplication::translate("Merge_sort", "Pause", nullptr));
        btnStart->setText(QCoreApplication::translate("Merge_sort", "Start", nullptr));
        lblOperation->setText(QCoreApplication::translate("Merge_sort", "TextLabel", nullptr));
        btnBack->setText(QCoreApplication::translate("Merge_sort", "back", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Merge_sort: public Ui_Merge_sort {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MERGE_SORT_H
