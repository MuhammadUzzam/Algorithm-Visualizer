/********************************************************************************
** Form generated from reading UI file 'bubble_sort.ui'
**
...
#ifndef UI_BUBBLE_SORT_H
#define UI_BUBBLE_SORT_H
...
public:
    ...
    void setupUi(QMainWindow *bubble_sort)
    {
        if (bubble_sort->objectName().isEmpty())
            bubble_sort->setObjectName("bubble_sort");
        bubble_sort->resize(772, 596);
        bubble_sort->setStyleSheet(QString::fromUtf8("QWidget {\n"
...
"    );\n"
"}"));
        centralwidget = new QWidget(bubble_sort);
...
"    }"));
        ...
        bubble_sort->setCentralWidget(centralwidget);
        menubar = new QMenuBar(bubble_sort);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 772, 18));
        bubble_sort->setMenuBar(menubar);
        statusbar = new QStatusBar(bubble_sort);
        statusbar->setObjectName("statusbar");
        bubble_sort->setStatusBar(statusbar);

        retranslateUi(bubble_sort);

        QMetaObject::connectSlotsByName(bubble_sort);
    } // setupUi

    void retranslateUi(QMainWindow *bubble_sort)
    {
        bubble_sort->setWindowTitle(QCoreApplication::translate("bubble_sort", "MainWindow", nullptr));
        lblTitle->setText(QCoreApplication::translate("bubble_sort", "Bubble Sort Visualization", nullptr));
        btnReset->setText(QCoreApplication::translate("bubble_sort", "Reset", nullptr));
        btnRandomize->setText(QCoreApplication::translate("bubble_sort", "Randomize", nullptr));
        btnPause->setText(QCoreApplication::translate("bubble_sort", "Pause", nullptr));
        btnStart->setText(QCoreApplication::translate("bubble_sort", "Start", nullptr));
        lblOperation->setText(QCoreApplication::translate("bubble_sort", "TextLabel", nullptr));
        btnBack->setText(QCoreApplication::translate("bubble_sort", "back", nullptr));
    } // retranslateUi

};

namespace Ui {
    class bubble_sort: public Ui_bubble_sort {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_BUBBLE_SORT_H
